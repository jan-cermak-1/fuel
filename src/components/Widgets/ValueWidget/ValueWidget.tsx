...
import arrowDownIcon from '../../assets/icons/13ca2775b44393bb99945b4fdc92d11824520bac.svg';
        ...
        <div className="value-widget__value">
          ...
          <div className="value-widget__relative-value">
            <div className={`value-widget__change ${changePositive ? 'value-widget__change--positive' : 'value-widget__change--negative'}`}>
              <img src={changePositive ? arrowUpIcon : arrowDownIcon} alt={changePositive ? 'Increase' : 'Decrease'} />
              <span>{change}</span>
            </div>
